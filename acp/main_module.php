...
class main_module
{
	...
	function main($id, $mode)
	{
		...
		$template->assign_block_vars('martin_emptypostsubjects_last_post_options', array(
			'L_TITLE'	=> $user->lang('ACP_EMPTYPOSTSUBJECTS_OPTION_' . EMPTYPOSTSUBJECTS_LAST_POST_SUBJECT),
			'OPTION'	=> EMPTYPOSTSUBJECTS_LAST_POST_SUBJECT,
			'SELECTED'	=> $config['martin_emptypostsubjects_last_post'] == EMPTYPOSTSUBJECTS_LAST_POST_SUBJECT,
		));
		$template->assign_block_vars('martin_emptypostsubjects_last_post_options', array(
